...
export function BrandPanel() {
  return (
    <section className="relative hidden flex-1 basis-[54%] flex-col justify-between overflow-hidden bg-gradient-to-br from-brand-navy-1 via-brand-navy-2 to-brand-navy-3 px-12 py-14 text-[#eaf1fb] lg:flex">
      {/* subtle glow accents */}
      ...
      <div className="relative flex items-center gap-3">
        <Image src={logo} alt="Risansi" width={200} height={200} className="rounded-xl bg-dark/10 p-1" />
      </div>
